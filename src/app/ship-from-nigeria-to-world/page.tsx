      ...
      <main className="pt-16">
        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-aos="fade-up">
            <h1 className="text-4xl md:text-5xl font-bold">International Shipping from Nigeria to the World</h1>
            <p className="text-lg md:text-xl mt-4 max-w-3xl mx-auto">Your #1 choice for shipping parcels, documents, and cargo from Nigeria to the UK, US, Canada, Europe, and over 200 countries worldwide.</p>
            <div className="mt-8">
