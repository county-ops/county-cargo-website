...
const stores = [
    ...
    { name: "Sports Direct", domain: "sportsdirect.com" }, { name: "Debenhams", domain: "debenhams.com" },
    { name: "Selfridges", domain: "selfridges.com" }, { name: "Harrods", domain: "harrods.com" },
    { name: "Superdrug", domain: "superdrug.com" }, { name: "Primark", domain: "primark.com" },
    { name: "Zara", domain: "zara.com" }, { name: "H&M", domain: "hm.com" },
    { name: "Matalan", domain: "matalan.co.uk" }, { name: "The Body Shop", domain: "thebodyshop.com" },
    { name: "Waitrose", domain: "waitrose.com" }, { name: "Sainsbury's", domain: "sainsburys.co.uk" },
    { name: "Asda", domain: "asda.com" }, { name: "TK Maxx", domain: "tkmaxx.com" },
    { name: "Dunelm", domain: "dunelm.com" }, { name: "The Range", domain: "therange.co.uk" },
    { name: "IKEA UK", domain: "ikea.com" }, { name: "PC World", domain: "currys.co.uk" },
    { name: "AO.com", domain: "ao.com" }, { name: "Apple UK", domain: "apple.com" },
    { name: "Nike UK", domain: "nike.com" }, { name: "Adidas UK", domain: "adidas.co.uk" },
    { name: "Footasylum", domain: "footasylum.com" }, { name: "Schuh", domain: "schuh.co.uk" },
    { name: "Clarks", domain: "clarks.co.uk" }, { name: "LookFantastic", domain: "lookfantastic.com" },
    { name: "Cult Beauty", domain: "cultbeauty.co.uk" }, { name: "Space NK", domain: "spacenk.com" },
    { name: "Feelunique", domain: "sephora.co.uk" }, { name: "New Look", domain: "newlook.com" },
