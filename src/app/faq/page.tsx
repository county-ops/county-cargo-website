    ...
    <>
      ...
      <main className="pt-20 faq-page">
        <div className="faq-container">
          ...
          <div className="faq-item"><h3 className="faq-toggle">How Much Does Shipping Cost?</h3><p className="faq-answer">Shipping costs depend on cargo weight, shipping method, and destination. Air freight is generally more expensive than sea freight. Get a precise quote via our website or support.</p></div>
          ...
          <div className="faq-item"><h3 className="faq-toggle">How Do I Track My Shipment?</h3><p className="faq-answer">All air freight shipments come with a tracking number and email updates throughout transit.</p></div>
