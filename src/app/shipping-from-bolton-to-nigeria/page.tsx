...
export const metadata: Metadata = {
  title: 'Shipping from Bolton to Nigeria | North West Cargo Pickup',
  description: 'Ship cargo from Bolton and North West to Nigeria. Doorstep collection across Bolton, Horwich, and Farnworth to Lagos & Abuja.',
  keywords: 'shipping from Bolton to Nigeria, Bolton cargo Lagos, air freight Bolton Nigeria, send excess baggage Bolton Nigeria',
  alternates: {
    canonical: 'https://countycargo.com/shipping-from-bolton-to-nigeria',
  },
};

const boltonFaqs = [
  {
    question: 'How do I schedule doorstep cargo pickup in Bolton?',
    answer: 'Book online via County Cargo. We collect packages across Bolton, Horwich, Farnworth, Westhoughton, and surrounding North West areas.',
  },
  {
...
export default function ShippingFromBoltonToNigeriaPage() {
  const serviceSchema = {
    '@context': 'https://schema.org',
    '@type': 'Service',
    name: 'Shipping from Bolton to Nigeria',
    provider: {
      '@type': 'Organization',
      name: 'County Cargo',
    ...
    description: 'Doorstep cargo collection across Bolton for delivery to Nigeria.',
  };
      ...
      <main className="pt-16 bg-white">
        <Breadcrumbs
          items={[
            ...
            { label: 'Shipping from Bolton to Nigeria' },
          ]}
        />
        ...
        <section className="py-12 md:py-16 bg-gradient-to-b from-blue-900 to-slate-900 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center" data-aos="fade-up">
            <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold bg-blue-500/20 text-blue-300 border border-blue-400/30 mb-4">
              <MapPin className="w-3.5 h-3.5" /> North West Doorstep Collection
            </span>
            ...
            <p className="text-lg md:text-xl mt-4 text-blue-100 font-light max-w-3xl mx-auto">
              Doorstep cargo pickup across Bolton with fast air freight delivery to Lagos and Abuja.
            </p>
          </div>
        </section>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-gray-800 leading-relaxed space-y-8">
            <div className="p-6 bg-blue-50 border border-blue-200 rounded-2xl">
              <h2 className="text-lg font-bold text-secondary flex items-center gap-2 mb-2">
                <Truck className="w-5 h-5 text-primary" /> Bolton Area Coverage
              </h2>
              <p className="text-sm text-gray-700">
                Collection available in Bolton Town Centre, Horwich, Farnworth, Westhoughton, Kearsley, and Little Lever.
              </p>
            </div>
            ...
            <div className="p-6 bg-gray-50 border border-gray-200 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                <h3 className="font-bold text-secondary text-lg">Book Bolton Collection</h3>
