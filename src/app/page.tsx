  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="relative pt-32 sm:pt-40 pb-16 sm:pb-24 bg-gradient-to-b from-[#071630] via-[#0b2149] to-[#0a192f] text-white overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
              ...
              <div className="lg:col-span-5 pt-2 sm:pt-6 text-left" data-aos="fade-right">
                {/* Service Timeframe Badge */}
                <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-500/20 border border-blue-400/30 text-xs font-semibold text-blue-200 mb-4 backdrop-blur-sm">
                  <span className="w-2 h-2 rounded-full bg-emerald-400 animate-pulse" />
                  <span>#1 Rated UK, US &amp; Nigeria Freight Logistics</span>
                </div>
                ...
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black text-white leading-tight tracking-tight">
                  ...
                  from UK to Nigeria &amp; Worldwide
                </h1>

                {/* Subtitle */}
                <p className="mt-4 text-sm sm:text-base text-blue-100/90 leading-relaxed">
                  Fast door-to-door <strong>Standard Air (5 to 10 working days)</strong>, <strong>Express Freight (3 to 5 working days)</strong>, <strong>48-Hour Special Express</strong> and container <strong>Sea Cargo (4 to 8 weeks)</strong> from London, Manchester, Birmingham, Leeds, Houston, and UK/US-wide directly to Lagos, Abuja, Port Harcourt, and all 36 Nigerian states. Full customs clearance included.
                </p>

                {/* Embedded Live Tracking Widget */}
                <div className="mt-6 p-4 rounded-2xl bg-white/10 border border-white/15 backdrop-blur-md">
                  ...
                  <form action="https://ship.countycargo.com/" method="GET" target="_blank" className="flex gap-2">
                    <input
                      type="text"
                      name="trackingNumber"
                      placeholder="Enter Airway Bill (AWB) or Tracking #..."
                      className="flex-1 h-11 px-3.5 bg-white text-gray-900 rounded-xl text-xs sm:text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-primary shadow-inner"
                      required
                    />
                    <Button type="submit" className="h-11 px-5 bg-primary hover:bg-blue-700 text-white font-bold text-xs sm:text-sm rounded-xl shadow-md shrink-0">
                      Track Cargo
                    </Button>
                  </form>
                </div>

                {/* Trust Stats Counter matching screenshot */}
                <div className="mt-8 pt-6 border-t border-white/15 grid grid-cols-3 gap-3 text-center sm:text-left">
                  <div>
                    <div className="text-lg sm:text-xl font-black text-white">5 to 10 Days</div>
                    <div className="text-[11px] text-blue-200 mt-0.5">Standard Air Delivery</div>
                  </div>
                  <div>
                    <div className="text-lg sm:text-xl font-black text-emerald-400">100%</div>
                    <div className="text-[11px] text-blue-200 mt-0.5">Customs Cleared</div>
                  </div>
                  <div>
                    <div className="text-lg sm:text-xl font-black text-white">36 States</div>
                    <div className="text-[11px] text-blue-200 mt-0.5">Doorstep Delivery</div>
                  </div>
                </div>

                {/* Portal Quick Access Buttons */}
                <div className="mt-6 flex items-center gap-3">
                  <Button asChild variant="outline" className="border-white/30 text-white hover:bg-white/10 text-xs sm:text-sm font-bold rounded-xl h-10 px-4">
                    <Link href="https://ship.countycargo.com/login">Client Portal Login</Link>
                  </Button>
                  <Button asChild className="bg-emerald-600 hover:bg-emerald-700 text-white text-xs sm:text-sm font-bold rounded-xl h-10 px-4">
