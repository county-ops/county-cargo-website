...
const faqs = [
  {
    ...
    answer: 'Express Air Courier (via DHL) takes 3 to 5 working days from Lagos or Abuja to major French addresses. Standard Air Cargo takes 5 to 8 working days including customs clearance at Paris Charles de Gaulle Airport (CDG).',
  },
  {
        ...
        <section className="py-12 md:py-16 bg-gradient-to-b from-blue-950 via-slate-900 to-blue-900 text-white relative overflow-hidden">
          <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10" data-aos="fade-up">
            ...
            <p className="text-lg md:text-xl mt-4 text-blue-100 max-w-3xl mx-auto font-light">
              Express Air Courier (3–5 days) &amp; Standard Air Cargo (5–8 days) to Paris, Lyon, Marseille, Toulouse, and Bordeaux.
            </p>
