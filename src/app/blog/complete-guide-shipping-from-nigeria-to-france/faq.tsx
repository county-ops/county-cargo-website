...
const faqs = [
  {
    ...
    answer:
      'Air cargo from Lagos (LOS) or Abuja (ABV) to Paris Charles de Gaulle (CDG) takes 3 to 5 working days for Express Courier and 5 to 8 working days for Standard Air Freight.',
  },
  {
    question: 'Which cities in France are covered for door delivery?',
    answer:
      'County Cargo delivers to major cities across France, including Paris, Lyon, Marseille, Toulouse, Bordeaux, and Lille.',
  },
];
    ...
    <section className="py-12 bg-gray-50 border-t border-gray-200">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2 mb-6">
          ...
          <h2 className="text-2xl font-bold text-secondary">Frequently Asked Questions: France Shipping</h2>
        </div>
