...
const faqs = [
  ...
  },
  {
    ...
    answer:
      'Express Air Courier takes 3 to 5 working days, while Standard Air Cargo takes 5–10 working days from London collection to Lagos arrival and customs clearance.',
  },
  {
