...
export const metadata: Metadata = {
  ...
  description: 'Compare DHL Express (3–5 working days) and standard air cargo (5–10 working days) timelines and per-kg pricing from Lagos and Abuja to American destination hubs.',
