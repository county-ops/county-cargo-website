...
const exportFaqs = [
  ...
  },
  {
    ...
    a: 'Express Export is our fastest service (typically 3 to 5 working days) with a 1 kg minimum chargeable weight, routed via premium global carriers like DHL Express with daily scheduled flights and end-to-end priority handling. Value Export is an economical consolidated air cargo service (typically 5–10 working days) suited for larger parcels (10kg minimum) to popular destinations like the United States, United Kingdom, and Canada.',
  },
  {
