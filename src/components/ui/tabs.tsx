...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-full border bg-transparent p-1 text-foreground",
      className
    )}
    {...props}
  />
